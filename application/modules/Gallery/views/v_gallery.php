                    ...
                    <div class="my-3 my-md-5">
                        ...
                        <div class="row row-cards row-deck">
                            <div class="col-12">
                                <div class="card">
									...
									<a href="<?php echo base_url().'gallery/add_gallery/';?>" class="btn btn-primary btn-lg"><i class="fa fa-plus"></i> Add Service</a>&nbsp;
									</div>
						...
						<tbody>
							...
							<tr>
								...
								<td>
								<?php if (!empty($data->gallery_image)): ?>
								<img src="<?php echo base_url('assets/images/gallery/'.$data->gallery_image) ?>" width="64" />
								<?php else : ?>
								<img src="<?php echo base_url('assets/images/gallery/default.jpg') ?>" width="64" />
								<?php endif; ?>
							</td>
